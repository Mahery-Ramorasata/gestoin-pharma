...
const utSub = document.getElementById('utSub');
const utBackBtn = document.getElementById('utBackBtn');

utBtn.addEventListener('click', () => {
utSub.style.display= 'flex'

});

utBackBtn.addEventListener('click', ()=>{
  utSub.style.display= 'none'
});
